...
define( [
	 ...
	 * called internally by {@link data.Model} and {@link data.Collection}. The tests may then want to check for the 
	 * correct loading/saving/destroying state "during" the requests. After that, the CRUD method should be either 
	 * resolved or rejected by the test, and then the correct state can be checked for afterwards.
	 * 
	 * 
	 * ## Example
	 * 
